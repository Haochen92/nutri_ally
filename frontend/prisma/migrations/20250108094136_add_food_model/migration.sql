-- CreateTable
CREATE TABLE "ProductNutrientsInfo" (
    "code" TEXT NOT NULL,
    ...
    CONSTRAINT "ProductNutrientsInfo_pkey" PRIMARY KEY ("code")
);

-- CreateIndex
CREATE UNIQUE INDEX "ProductNutrientsInfo_code_key" ON "ProductNutrientsInfo"("code");
