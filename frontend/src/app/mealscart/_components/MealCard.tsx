...
interface MealCardProps {
  ...
  userId: string | null;
  foodArray: MealItem[];
  mealNutrition: Record<string, number>;
  isLoggedIn: boolean;
}

export default function MealCard({ mealType, userId, foodArray, mealNutrition, isLoggedIn }: MealCardProps) {
